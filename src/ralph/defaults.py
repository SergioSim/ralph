...
XAPI_ANONYMIZATION_HASH_LENGTH = config("RALPH_XAPI_ANONYMIZATION_HASH_LENGTH", 64)
XAPI_ANONYMIZATION_HASH_SLICE_INDEXES = config(
    "RALPH_XAPI_ANONYMIZATION_HASH_SLICE_INDEXES", ""
)
XAPI_ANONYMIZATION_MEMORY_COST = config("RALPH_XAPI_ANONYMIZATION_MEMORY_COST", 8)
XAPI_ANONYMIZATION_PARALLELISM = config("RALPH_XAPI_ANONYMIZATION_PARALLELISM", 1)
XAPI_ANONYMIZATION_SALT = config("RALPH_XAPI_ANONYMIZATION_SALT", "")
XAPI_ANONYMIZATION_TIME_COST = config("RALPH_XAPI_ANONYMIZATION_TIME_COST", 1)
