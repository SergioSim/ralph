...
def browser_event(event_number):
...
def event():
    ...
    def _event(event_number, event_type="server"):
        return EVENT_TYPES.get(event_type, server_event)(event_number)
