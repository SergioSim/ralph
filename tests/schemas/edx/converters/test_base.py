...
class TestBaseConverter(BaseConverter):
...
BASE_CONVERTER = TestBaseConverter()
...
def get_patched_base_converter(conversion_dictionary, schema=ContextModuleSchema):
    """Returns a TestBaseConverter that returns with given conversion_dictionary and schema"""

    # pylint: disable=protected-access, attribute-defined-outside-init
    TestBaseConverter.get_conversion_dictionary = lambda self: conversion_dictionary
    base_converter = TestBaseConverter()
